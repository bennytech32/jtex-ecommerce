        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li><a href="/help?tab=faq" className="hover:text-[#F2A900] transition flex items-center gap-2"><span className="text-[#F2A900] text-xs">▸</span> Help Center</a></li>
              <li><a href="/help?tab=track" className="hover:text-[#F2A900] transition flex items-center gap-2"><span className="text-[#F2A900] text-xs">▸</span> Track Your Order</a></li>
              <li><a href="/help?tab=returns" className="hover:text-[#F2A900] transition flex items-center gap-2"><span className="text-[#F2A900] text-xs">▸</span> Returns & Refunds</a></li>
              <li><a href="/help?tab=shipping" className="hover:text-[#F2A900] transition flex items-center gap-2"><span className="text-[#F2A900] text-xs">▸</span> Shipping Information</a></li>
              <li><a href="/help?tab=faq" className="hover:text-[#F2A900] transition flex items-center gap-2"><span className="text-[#F2A900] text-xs">▸</span> FAQs</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li><a href="/" className="hover:text-[#F2A900] transition flex items-center gap-2"><span className="text-[#F2A900] text-xs">▸</span> Home</a></li>
              <li><a href="/?cart=open" className="hover:text-[#F2A900] transition flex items-center gap-2"><span className="text-[#F2A900] text-xs">▸</span> View Cart</a></li>
              <li><a href="/profile" className="hover:text-[#F2A900] transition flex items-center gap-2"><span className="text-[#F2A900] text-xs">▸</span> My Account</a></li>
              <li><a href="/profile" className="hover:text-[#F2A900] transition flex items-center gap-2"><span className="text-[#F2A900] text-xs">▸</span> Order History</a></li>
            </ul>
          </div>
