...
export default function HomePage() {
  ...
  const [deliverLocation, setDeliverLocation] = useState('Tanzania');
  ...
  // REUSABLE PRODUCT CARD (Fix for truncated text)
    ...
    return (
      <div className="bg-white rounded-xl p-3 sm:p-4 shadow-sm hover:shadow-md transition border border-gray-100 flex flex-col h-full group cursor-pointer" onClick={() => setSelectedProduct(product)}>
        ...
        <div className="flex-1 flex flex-col">
          {/* FIX: line-clamp-2 with min-h-[40px] and pb-1 prevents text cutoff at the bottom */}
