...
import { 
  FiLock, FiMail, FiArrowRight, FiEye, FiEyeOff, 
  FiShield, FiChevronLeft, FiBox, FiCreditCard, 
  FiStar, FiHeadphones, FiCheckCircle 
} from 'react-icons/fi';
import Link from 'next/link';

// FIREBASE IMPORTS (Make sure you have frontend/app/firebase.ts configured)
...
export default function CustomerLoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    if (cleanEmail && cleanPassword) {
        // Hii ni Mock Token kwa ajili ya Custom Email Login
  ...
  const handleGoogleLogin = async () => {
    try {
        ...
        localStorage.setItem('jtex_token', await user.getIdToken()); 
        localStorage.setItem('jtex_user', JSON.stringify({
            id: user.uid,
        ...
        setIsLoading(false);
        setError("Imeshindwa kuingia na Google. Jaribu tena.");
  ...
  return (
    <div className="min-h-screen bg-[#060B19] text-white relative font-sans selection:bg-[#F2A900] selection:text-black overflow-x-hidden flex justify-center">
      ...
      {/* BACKGROUND IMAGE - Imerekebishwa ili ionekane safi kabisa */}
      <div className="absolute top-0 left-0 w-full lg:w-[65%] h-[50vh] lg:h-full z-0 overflow-hidden pointer-events-none">
        ...
        />
        {/* Gradient imewekwa vizuri isifunike picha sana */}
        <div className="absolute inset-0 bg-gradient-to-b from-[#060B19]/20 via-[#060B19]/70 to-[#060B19] lg:bg-gradient-to-r lg:from-transparent lg:via-[#060B19]/80 lg:to-[#060B19]"></div>
      </div>
      ...
      <div className="relative z-10 w-full max-w-[1600px] mx-auto flex flex-col lg:flex-row min-h-screen">
        ...
        <div className="w-full lg:w-[55%] xl:w-[60%] px-6 pt-8 pb-4 lg:p-12 xl:p-16 flex flex-col justify-between">
            ...
            <div className="flex justify-between items-center w-full">
                <Link href="/" className="p-2.5 bg-[#060B19]/60 hover:bg-[#060B19]/80 rounded-xl transition backdrop-blur-md border border-white/10">
                ...
                <div className="flex items-center gap-3">
                    <button className="flex items-center gap-2 text-sm font-bold bg-[#060B19]/60 hover:bg-[#060B19]/80 border border-white/10 px-4 py-2.5 rounded-full transition backdrop-blur-md">
            ...
            <div className="mt-12 lg:mt-0 text-center lg:text-left max-w-xl mx-auto lg:mx-0">
                ...
                <p className="text-sm sm:text-base text-gray-300 leading-relaxed hidden lg:block max-w-md drop-shadow-md bg-[#060B19]/50 p-4 rounded-xl backdrop-blur-md border border-white/10">
            ...
            <div className="hidden lg:grid grid-cols-4 gap-6 max-w-3xl mt-12">
                <div className="space-y-3 bg-[#060B19]/60 p-4 rounded-2xl backdrop-blur-md border border-white/10">
        ...
        <div className="w-full lg:w-[45%] xl:w-[40%] px-4 pb-8 lg:p-12 flex flex-col justify-center mt-6 lg:mt-0 relative z-20">
            ...
            <div className="bg-[#0F172A]/95 border border-gray-800/80 rounded-[2rem] p-6 sm:p-10 shadow-2xl backdrop-blur-xl">
                ...
                {/* Social Login Buttons (Na Google Auth Logic Mpya) */}
                <div className="grid grid-cols-3 gap-3">
                    <button type="button" onClick={handleGoogleLogin} className="flex items-center justify-center gap-2 bg-white hover:bg-gray-100 text-gray-900 py-3 rounded-xl text-xs sm:text-sm font-bold transition">
                    ...
                    <button type="button" className="flex items-center justify-center gap-2 bg-white hover:bg-gray-100 text-gray-900 py-3 rounded-xl text-xs sm:text-sm font-bold transition">
                    ...
                    <button type="button" className="flex items-center justify-center gap-2 bg-white hover:bg-gray-100 text-[#1877F2] py-3 rounded-xl text-xs sm:text-sm font-bold transition">
