...
import { 
  ...
  FiChevronRight, FiSearch, FiMoreVertical, FiMessageCircle, FiHome, FiCheckCircle 
} from 'react-icons/fi';
      ...
      <main className="max-w-7xl mx-auto lg:px-6 lg:py-8">
        ...
        <div className="flex flex-col lg:flex-row gap-0 lg:gap-10 mb-8 lg:mb-12">
          ...
          <div className="w-full lg:w-1/2 flex flex-col px-4 lg:px-0 mt-4 lg:mt-0">
            ...
            <div className="bg-gray-50 rounded-xl p-3 border border-gray-100 mb-5">
              <p className="text-[11px] font-semibold text-gray-600 mb-2">Wholesale Pricing (Minimum Order 1 Piece)</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 border-t border-gray-100 pt-8 lg:pt-12 mb-12 px-4 lg:px-0">
          <div>
            ...
            <p className="text-gray-600 text-sm leading-relaxed bg-gray-50/50 p-6 rounded-2xl border border-gray-100">
          ...
          <div>
            ...
            <div className="bg-white rounded-2xl p-2">
              ...
              {Object.keys(specs).length > 0 ? (
                ...
                <div className="py-4 text-sm text-gray-500 px-2">No additional specifications available for this product.</div>
              )}
            </div>
          </div>
        </div>
